...
<span class="cstat-no" title="statement not covered" >      console.log(messageLogLevel);</span>
 ...
 * @param level
 */
const level = <span class="fstat-no" title="function not covered" >le</span>vel =&gt; {
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >fu</span>nction(client) {</span>
<span class="cstat-no" title="statement not covered" >    logger(client, level);</span>
  };
};
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Apr 15 2020 15:39:59 GMT+0200 (CEST)
</div>
</div>
