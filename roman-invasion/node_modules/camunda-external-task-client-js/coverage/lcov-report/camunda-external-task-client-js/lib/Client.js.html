...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!isUndefinedOrNull(processVariables)) {
<span class="cstat-no" title="statement not covered" >          topic.processVariables = processVariables;</span>
        }
&nbsp;
